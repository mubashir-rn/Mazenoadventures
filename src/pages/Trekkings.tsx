...
const Trekkings = () => {
  ...
  // Combine all treks into a single array
  const allTreks = [
    {
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-4xl font-bold text-foreground mb-4">All Treks</h2>
              <p className="text-muted-foreground">Explore our complete collection of trekking adventures in Pakistan</p>
            </div>
